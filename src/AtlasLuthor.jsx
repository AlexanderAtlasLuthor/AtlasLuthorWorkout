...
import HomeScreen from "./features/HomeScreen.jsx";
      ...
      <div className="page-shell">
        ...
        {activeUserId && screen === "home" && (
          <HomeScreen
            ...
            isProgressionDue={isProgressionDue}
            lastProgressionReview={lastProgressionReview}
            progressionItems={progressionItems}
            rejectProgression={rejectProgression}
            acceptProgression={acceptProgression}
            days={days}
          ...
          <div className="fade-up feature-page">
            ...
            {activeFeaturePage === "nutrition" && (
              <NutritionPage
                ...
                todayMacros={todayMacros}
                macroTargets={macroTargets}
                nutritionBMR={nutritionBMR}
                nutritionTDEE={nutritionTDEE}
                profile={profile}
                setProfile={setProfile}
                isAutoActivity={isAutoActivity}
                autoActivityLevel={autoActivityLevel}
                weeklyMetrics={weeklyMetrics}
                foodLog={foodLog}
                todayFood={todayFood}
